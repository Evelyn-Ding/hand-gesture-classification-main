...
Usage:
    ...
    $ python path/to/--weights runs/train/yolo_road_det/weights/best.pt --conf 0.25 --name yolo_road_det.py --data coco128.yaml --weights '' --cfg yolov5s.yaml --img 640  # from scratch
"""
